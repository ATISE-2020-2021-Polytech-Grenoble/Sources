...
#
# Generated by export_simulation on Fri Mar 27 10:22:29 +0100 2020
#
################################################################################
...
'-reset_run' switch to the './MarsZX3.sh' script.

./MarsZX3.sh -reset_run
...
./MarsZX3.sh -noclean_files

For more information on the script, please type './MarsZX3.sh -help'.
