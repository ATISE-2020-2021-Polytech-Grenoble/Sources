...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_HDPyx_TPG is
  ...
  signal \data_gen_q[4]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of clk_out_INST_0 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \data_gen_q[1]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \data_gen_q[1]_i_4\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \data_gen_q[3]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \data_gen_q[3]_i_4\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \data_gen_q[4]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \data_gen_q[4]_i_3\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \tpg_state_q[2]_i_6\ : label is "soft_lutpair6";
begin
...
\data_gen_q[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000000AACC0FCCAA"
    )
        port map (
      I0 => sof_counter_q(2),
      I1 => \data_gen_q[4]_i_2_n_0\,
      I2 => \data_gen_q[4]_i_3_n_0\,
      I3 => tpg_state_q(2),
      I4 => tpg_state_q(1),
      I5 => tpg_state_q(0),
      O => data_gen_d(4)
    );
\data_gen_q[4]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\data_gen_q[4]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\data_gen_q[5]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF80"
    )
        port map (
      ...
      I1 => eof_counter_q(1),
      I2 => eof_counter_q(0),
      I3 => \data_gen_q[5]_i_3_n_0\,
      O => data_gen_d(5)
    );
\data_gen_q[5]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFF0000D5805500"
    )
        port map (
      I0 => tpg_state_q(1),
      I1 => eol_counter_q(1),
