...
HD_PWD='C:/FMa/ATISE/Development/Clean_ENV/design-16b_1CLK_1SENSOR/design_mars/Vdo/MarsZX3_EB1.runs/MarsZX3_DCMI_VDMA_Bridge_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MarsZX3_DCMI_VDMA_Bridge_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MarsZX3_DCMI_VDMA_Bridge_0_2.tcl
