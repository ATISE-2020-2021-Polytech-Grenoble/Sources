...
HD_PWD='C:/fab/work/atise/trunk/projects/hdpyx_2019/updates_fab_1/design_mars/Vdo/MarsZX3_EB1.runs/MarsZX3_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MarsZX3_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MarsZX3_axi_gpio_0_0.tcl
