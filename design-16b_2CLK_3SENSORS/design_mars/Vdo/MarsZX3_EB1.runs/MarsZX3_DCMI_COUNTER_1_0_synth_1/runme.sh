...
HD_PWD='C:/FMa/ATISE/Development/Clean_ENV/design-16b_2CLK_3SENSORS_modif/design_mars/Vdo/MarsZX3_EB1.runs/MarsZX3_DCMI_COUNTER_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MarsZX3_DCMI_COUNTER_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MarsZX3_DCMI_COUNTER_1_0.tcl
